    ...
    public partial class InitialPostgresCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    UserNameDisplay = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FriendsList_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: false),
                    HabitIcon = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserOneLastCheckedInAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UserTwoLastCheckedInAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastFullyCompletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UserOneVisibilityPublic = table.Column<bool>(type: "boolean", nullable: false),
                    UserTwoVisibilityPublic = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
