  ...
  return (
    <div className={`min-h-screen p-6 transition-colors duration-300 ${
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <h1 className={`text-2xl ${isDark ? 'text-slate-100' : 'text-slate-800'}`}>
          My Friends
        </h1>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 text-white">
                        {user.avatar}
                      </div>
