...
type Screen = 'auth' | 'tracker' | 'selector' | 'config';
...
export default function App() {
  // User state stores { id, userName, email } returned from C# API
  ...
  // Conditional Rendering: If no user is logged in, show AuthScreen
  if (!user) {
    return (
  ...
  // Main App Flow (Only visible after successful Login)
  return (
    <div className="size-full">
